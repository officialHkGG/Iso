...
export function AuditActions({ audit, users = [], onUpdate }: AuditActionsProps) {
  ...
  const handleDelete = async () => {
    setLoading(true)
    try {
      await auditStorage.delete(audit.id)
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This will permanently delete &quot;{audit.title}&quot;.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
